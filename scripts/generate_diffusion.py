...
def main(argv):
    ...
    parser.add_argument(
        ...
        # default="/home/shanhai/outputs/diffuscene/threed_future_model_bedroom.pkl",
    ...
    if args.scene_id:
        for i, di in enumerate(raw_dataset):
            if str(di.scene_id) == args.scene_id:
                print('found scene id:', di.scene_id)
                given_scene_id = i
    ...
    for i in range(args.n_sequences):
        ...
        # print(boxes["class_labels"].shape)#torch.Size([1, 4, 21])
        # print(boxes["translations"].shape)#torch.Size([1, 4, 3])
        # print(boxes["sizes"].shape)#torch.Size([1, 4, 3])
        # print(boxes["angles"].shape)#torch.Size([1, 4, 1])
        print('Generated bbox:', bbox_params_t.shape)#Generated bbox: (1, 4, 28)
